...
/*        this.mesh.position.y = 0;
        ...
        this.group.position.set(-12, 1, -7);
...
//        this.material.uniforms.uColorStrength.value = 0.125 + this.audioAnalizer.averageFrequency[2] / 192;
        ...
        this.osciloscopeCylinder1.mesh.scale.set(0.01 + (this.audioAnalizer.averageFrequency[0] / 255),
                                                 0.01 + (this.audioAnalizer.averageFrequency[0] / 255),
                                                 0.01 + (this.audioAnalizer.averageFrequency[0] / 255));
        this.osciloscopeCylinder2.mesh.scale.set(0.1 + (this.audioAnalizer.averageFrequency[1] / 255),
                                                 0.1 + (this.audioAnalizer.averageFrequency[1] / 255),
                                                 0.1 + (this.audioAnalizer.averageFrequency[1] / 255));
        this.osciloscopeCylinder3.mesh.scale.set(0.2 + (this.audioAnalizer.averageFrequency[2] / 255),
                                                 0.2 + (this.audioAnalizer.averageFrequency[2] / 255),
                                                 0.2 + (this.audioAnalizer.averageFrequency[2] / 255));
        ...
        this.barsCylinder.mesh.rotation.set(0, this.barsCylinder.mesh.rotation.y + advance * 15, 0);
