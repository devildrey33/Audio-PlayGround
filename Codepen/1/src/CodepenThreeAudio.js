 ...
 * 
 *  #1 is the most basic shader, a linear osciloscope.
 *      - This script creates an audio data texture with the getByteTimeDomainData values 
 *        on the green channel. (Its more easy than creating extra attributes, and looks better)
 *      - Then this texture is sent to the osciloscope shader and the osciloscope depth shader.
 *      - You can drag & drop any song of your computer to play it.
 *      - Song name   : After Us
 *        Song artist : From Sky To Abyss
...
export default class CodepenThreeAudio {
    ...
    options = {
        ...
        orbitControls           : true,
        // Song path
        songPath                : "https://devildrey33.es/Ejemplos/Three.js-Journey/Audio-PlayGround/songs/After_Us_-_From_Sky_to_Abyss.mp3"
    };    
